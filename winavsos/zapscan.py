...
def start_zap(zap_path):
    zap_process = subprocess.Popen(["python", zap_path], stdout=subprocess.PIPE, stderr=subprocess.PIPE)

    # Sleep for a specified duration to give ZAP time to start and complete the tests
    time.sleep(120)
    return zap_process
